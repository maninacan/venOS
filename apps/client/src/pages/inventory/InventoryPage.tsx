    ...
    <>
      ...
      <div className="card">
        <div className="mb-4">
          ...
          <p className="text-[#64748b] text-[0.86rem] m-0">{t('subtitle', 'Upload your product catalog once — Venview tracks stock and calculates COGS automatically after every Square sync.')}</p>
        </div>
